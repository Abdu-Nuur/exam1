...
public class App 
{
    public static void main( String[] args ) {
        ...
        Course course = new Course("Java",9, LocalDate.of(2020,11,12),"78g2$%&&%**K#@1","Backend");
        Course course2 = new Course("Java Script",9, LocalDate.of(2020,10,21),"85&THDE#%@","Frontend");

        Instructor instructor = new Instructor("Nurisa","Mamiraimova","nuri.0303@gmail.com","+996553821234");
        Instructor instructor1 = new Instructor("Aijamal","Asangazieva","aijamal.12@gmail.com","+992609768934");
        Instructor instructor2 = new Instructor("Munarjan","Aitbekova","muna.12@gmail.com","+996749968934");

        Lesson lesson = new Lesson("Hibernate","57858h$#%%$^#QQ");
        Lesson lesson1 = new Lesson("JDBC","5858h$##%%$^#QQ");
        Lesson lesson2 = new Lesson("SQL","jfkln58h$##%%$^#QQ");
        ...
        Task task1 = new Task("HomeWork 6 ",LocalDate.of(2022,7,16),"");
